...
| `user` | 프로필 조회 | `/api/users/**` |
| `couple` | 초대 코드(`Invitation`) · 커플 연결(`Couple`, 양방향 WAIT→CONNECTED)/해제 | `/api/couples/**` |
| `goal` | 부부 공동 목표 + 공동 투자성향(온보딩 5단계 · `RiskProfileCalculator`) | `/api/goals/**` |
